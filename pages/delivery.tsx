    ...
    <>
      ...
      <main>
        <div>
          ...
          <h2>Shipping</h2>
          <p>
            Orders received on working days will be shipped within 48hours. The
            Products are shipped through our courier partners. All products are
            shipped directly from our HO in Indore.
          </p>
          <h2>CHARGES</h2>
          <p>
          ...
          <h2>TIME FRAME</h2>
          <p>All delivery dates posted online and offline are
          estimated lead times. Estimated lead times and delivery times are
          always subject to change without notification. Seller cannot be held
          responsible for any delay in delivery or extended lead times. SHIPPING
          CHARGES Shipping costs are based on weight and are calculated at the
          time of selecting the item. To reflect the policies of the courier
          companies we use, all weights will be rounded up to the next full kg.
          </p>
        </div>
      </main>
      <Footer />
